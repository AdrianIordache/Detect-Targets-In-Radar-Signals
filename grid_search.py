        ...
        for model_cfg in experiments_cfg['model_config']:
            for optimizer in experiments_cfg['optimizers']:
                for schedulers in experiments_cfg['schedulers']:
                    for swa_parameters in experiments_cfg['swa']:
                        for learning_rate in experiments_cfg['lrs']:
                            ...
                            if SAVE_MODEL:
                                ...
                                for fold, (accuracy, model) in enumerate(swa_best_models): 
                                    torch.save(
                                        model, 
                            ...
                            print(f'[GPU-{GPU}] SWA Experiment {counter}/{no_experiments} -> SWA Accuracy: {swa_accuracy}')
                            logger.close()
                            
                            del best_models, swa_best_models
                            gc.collect()
